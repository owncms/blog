        ...
        <div class="container-fluid page-content__top-content">
            <div class="page-content__top-details">
                <a href="{{ build_crud_route('index') }}" class="return-back"><i
                        class="fas fa-long-arrow-alt-left"></i> Articles</a>
                @if($item->id)
            ...
            <div class="page-content__top-buttons d-flex">
                @if(isset($edit) && $edit == 1)
                    <button type="submit" class="btn btn--delete"
                            form="articleForm">@lang('admin::main.delete')</button>
                    <button type="submit" class="btn btn--edit" form="articleForm">@lang('admin::main.update')</button>
                @elseif(!$item->id)
                    <button type="submit" class="btn btn--create" form="articleForm">@lang('admin::main.save')</button>
                @else
        ...
        <div class="container-fluid">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    @endif
                    {!! form_start($form, ['id' => 'articleForm']) !!}
                    <div class="container-fluid">
